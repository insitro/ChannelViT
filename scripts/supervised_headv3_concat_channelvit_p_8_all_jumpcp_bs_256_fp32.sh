NICKNAME="supervised_headv3_concat_channelvit_p_8_all_jumpcp_bs_256_fp32"


python amlssl/main/main_supervised_multihead.py \
...
meta_arch/backbone=headv3channelvit_small \
meta_arch.backbone.args.in_chans=8 \
meta_arch.backbone.args.patch_size=8 \
meta_arch.multihead=concat \
...
val_data_dict.jumpcp_test.loader.batch_size=4 \
...
#python amlssl/main/main_supervised_multihead_evalall.py \
#wandb.project="amlssl-supervised" \
#nickname="${NICKNAME}" \
#trainer.devices=8 \
#trainer.precision=32 \
...
#meta_arch=supervised_multihead \
#meta_arch/backbone=headv3channelvit_small \
#meta_arch.backbone.args.in_chans=8 \
#meta_arch.target='label' \
#meta_arch.num_classes=161 \
