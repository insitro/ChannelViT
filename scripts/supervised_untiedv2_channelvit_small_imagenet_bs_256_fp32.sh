NICKNAME="supervised_untiedv2_channelvit_small_imagenet_bs_256_fp32"
...
meta_arch/backbone=untiedv2channelvit_small \
meta_arch.target='ID' \
...
train_data.imagenet.args.sample_channels=2 \
