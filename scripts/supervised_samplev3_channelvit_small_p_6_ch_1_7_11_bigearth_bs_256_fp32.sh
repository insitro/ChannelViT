NICKNAME="supervised_samplev3_channelvit_small_p_10_ch_1_7_11_bigearth_bs_256_fp32"
...
train_data.bigearth.args.channels=[1,7,11] \
...
val_data_dict.bigearth_val.args.channels=[1,7,11] \
...
val_data_dict.bigearth_test.args.channels=[1,7,11] \
