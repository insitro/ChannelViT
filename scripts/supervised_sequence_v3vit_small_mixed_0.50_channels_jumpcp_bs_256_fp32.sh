NICKNAME="supervised_sequence_v3vit_small_mixed_0.50_channels_jumpcp_bs_256_fp32"
...
data@train_data=[jumpcp,jumpcp_fluro_bright] \
...
train_data.jumpcp.args.channel_mask=True \
train_data.jumpcp.args.split="train" \
train_data.jumpcp.args.scale=1.6 \
train_data.jumpcp_fluro_bright.loader.num_workers=32 \
train_data.jumpcp_fluro_bright.loader.batch_size=32 \
train_data.jumpcp_fluro_bright.loader.drop_last=True \
train_data.jumpcp_fluro_bright.args.channels=[0,1,2,3,4,5,6,7] \
train_data.jumpcp_fluro_bright.args.split="fluro_bright_0.50" \
...
val_data_dict.jumpcp_test.args.channel_mask=True \
transformations@train_transformations=cell \
transformations@val_transformations=cell \
...
train_data.jumpcp_fluro.args.split="fluro_0.50" \
