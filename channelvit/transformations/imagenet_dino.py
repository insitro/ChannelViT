...
class ImagenetAugmentationDino(object):
    """This is the data augmentaiton for DINO training on ImageNet
    """
    ...
    def __init__(
        ...
        self.normalize = transforms.Compose([transforms.CenterCrop(224), normalize])
